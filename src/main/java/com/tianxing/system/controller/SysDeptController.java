...
public class SysDeptController extends BaseController {
    ...
    */
    ...
    public ApiResult list(){
        ...
        return new ApiResult(iSysDeptService.page(page, Wrappers.emptyWrapper()));
    }
    ...
    */
     ...
     * @return
     */
    @RequestMapping(value = "deptZtree", produces = "application/json;charset=utf-8")
    @ResponseBody
    public ApiResult deptZtree(){
        return new ApiResult(iSysDeptService.findSysDeptZtree());
    }
}
